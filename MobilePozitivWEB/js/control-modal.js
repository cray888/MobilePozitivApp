...
ModalApp.ModalProcess = function (parameters) {  
	...
	'<div class="input-group" style="padding-left: 10px; width:250px; "><span class="input-group-addon" id="basic-addon">Поиск:</span><input type="text" class="form-control" aria-describedby="basic-addon" id="search_in_datalist"></div>'+
	'</div>'+
